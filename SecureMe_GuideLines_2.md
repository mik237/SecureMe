...
- [ ] Stage 1: Project Setup & Empty App Shell
- [ ] Stage 2: Splash Screen
- [ ] Stage 3: Navigation Graph & Screen Skeletons
- [ ] Stage 4: Authentication UI
- [ ] Stage 5: Firebase Authentication Integration
- [ ] Stage 6: Onboarding — Password Setup & Key Derivation
- [ ] Stage 7: Cryptographic Core — Master Key
